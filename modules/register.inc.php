<?php 
 ...
 if($_SERVER['REQUEST_METHOD'] == 'POST'){
 	...
 	if(empty($errors)){
 		...
 		$q = "INSERT INTO users(username,password,user_type) VALUES ('$un','$p','$utype')";
 		...
 		if($r){//Run ok
          ...
          exit;
 			...
 			echo '<h2 class="error">ERROR:</h2> Your data could not be inserted into our records due a system error.
 					We appolize with you by the inconveniences.';
 		}
...
<h1>User's Registration System</h1>
        <form action="index.php?p=register" method="post">
          <div class="form_settings">
            ...
            <p><span>User Type:</span><select class="contact" name="utype"><option value="admin">Administrator</option><option value="faculty">Professor</option><option value="student">Student</option></select></p>
            <?php } else {?> 
            <p><span>User Type:</span><select class="contact" name="utype"><option value="faculty">Professor</option><option value="student">Student</option></select></p>
            <?php }?>
